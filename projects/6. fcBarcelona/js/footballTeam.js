var players = [
    { name: "Sergi", lastname: "Puig", number: 1, img: "images/player1.jpg" },
    ...
    { name: "Jordi", lastname: "Alba", number: 18, img: "images/player6.jpg" },
    {
        ...
        lastname: "Busquets",
        number: 5,
        img: "images/player7.jpg"
    },
    {
        name: "Frenkie",
        lastname: "deJong",
        number: 21,
        img: "images/player8.jpg"
    },
    ...
    { name: "Lionel", lastname: "Messi", number: 10, img: "images/player11.jpg" },
    {
        ...
        lastname: "Griezmann",
        number: 17,
        img: "images/player12.jpg"
    },
    {
        name: "Martin",
        lastname: "Braithwaite",
        number: 19,
        img: "images/player13.jpg"
    },
    {
        name: "Ousmane",
        lastname: "Dembele",
        number: 11,
        img: "images/player14.jpg"
    },
...
function changePlayers() {
    var firstTeamPlayers = document.querySelectorAll("#first-team div");
    var randomA = randomNumber(firstTeamPlayers.length);
    secondTeam.appendChild(firstTeamPlayers[randomA]);

    var secondTeamPlayers = document.querySelectorAll("#second-team div");
